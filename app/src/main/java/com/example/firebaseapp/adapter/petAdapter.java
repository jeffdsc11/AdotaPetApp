...
import com.example.firebaseapp.functions.AdapterAdmin;
...
public class petAdapter extends FirebaseRecyclerAdapter<
        PetModel, petAdapter.petViewholder> {
                     ...
                     int position, @NonNull PetModel model)
    {
       ...
       holder.v.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               ...
               Intent intent = new Intent(view.getContext(), VerDogDetalhes.class);
